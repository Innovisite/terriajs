...
is invalid.  The catalogue item has been hidden from the map.  You may re-show it in the Now Viewing panel to try again.'
        ...
        result.errorEvent.addEventListener(function(sender, message) {
            ...
            catalogItem.terria.error.raiseEvent({
                ...
                message: '\
"' + catalogItem.name + '" ne peut être affiché en 2D car il n\'est pas compatible avec le format standard de projection Web Mercator (EPSG:3857).  \
Veuillez utiliser la vue 3D et réessayer d\'activer la source de données.'
            });
