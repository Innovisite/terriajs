...
TableDataSource.prototype.setDisplayStyle = function (style) {
    ...
    // this.setDataVariable(style.dataVariable);  // this used to be set here, but now set via the setSelectedFunction
    updateEntities(this);
};
...
TableDataSource.prototype.getLegendGraphic = function () {
    function drawGradient(ctx, gradH, gradW, colorMap, singleValueLegend) {
    ...
    drawGradient(ctx, gradH, gradW, this.colorMap, singleValueLegend);
