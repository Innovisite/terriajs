...
CatalogMemberControl.prototype.requiredProperty = function() {
    if (!defined(this.requiredPropertyName)) {
        throw new DeveloperError('Le nom de la propriété requise n\'est pas défini.');
    }
    ...
    throw new DeveloperError('La propriété requise n\'est pas défini dans la liste du catalogue.');
};
...
CatalogMemberControl.leftSideItemControls = function(catalogMember) {
    deprecationWarning('CatalogMemberControl.leftSideItemControls', 'leftSideItemControls is deprecated.  Please use leftSideMemberControls instead');
    return this.leftSideMemberControls(catalogMember);
};


CatalogMemberControl.rightSideItemControls = function(catalogMember) {
    deprecationWarning('CatalogMemberControl.rightSideItemControls', 'rightSideItemControls is deprecated.  Please use rightSideMemberControls instead');
    return this.rightSideMemberControls(catalogMember);
};
