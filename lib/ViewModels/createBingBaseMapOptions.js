...
var createBingBaseMapOptions = function(terria, bingMapsKey) {
    ...
    result.push(new BaseMapViewModel({
        image: require('../../wwwroot/images/france-bing-aerial-labels.png'),
    ...
    result.push(new BaseMapViewModel({
        image: require('../../wwwroot/images/france-bing-aerial.png'),
    ...
    result.push(new BaseMapViewModel({
        image: require('../../wwwroot/images/france-bing-maps-roads.png'),
