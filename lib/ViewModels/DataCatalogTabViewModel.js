...
var DataCatalogTabViewModel = function(options) {
    ExplorerTabViewModel.call(this, defaultValue(options.name, '@<<DATA_CATALOG_NAME>>@'),
...
DataCatalogTabViewModel.prototype.getRightSideItemControls = function(catalogMember) {
    deprecationWarning('getRightSideItemControls', 'getRightSideItemControls is deprecated. \
Please use getRightSideMemberControls instead');
    return CatalogMemberControl.rightSideMemberControls(catalogMember);
};

DataCatalogTabViewModel.prototype.getLeftSideItemControls = function(catalogMember) {
    deprecationWarning('getLeftSideItemControls', 'getLeftSideItemControls is deprecated. \
Please use getLeftSideMemberControls instead');
    return CatalogMemberControl.leftSideMemberControls(catalogMember);
};
