...
var createGlobalBaseMapOptions = function(terria, bingMapsKey) {
    ...
    result.push(new BaseMapViewModel({
        image: require('../../wwwroot/images/france-natural-earth.png'),
    ...
    result.push(new BaseMapViewModel({
        image: require('../../wwwroot/images/france-black-marble.png'),
    ...
    result.push(new BaseMapViewModel({
        image: require('../../wwwroot/images/france-positron.png'),
    ...
    result.push(new BaseMapViewModel({
        image: require('../../wwwroot/images/france-dark-matter.png'),
