...
var createGlobalBaseMapOptions = function(terria, bingMapsKey) {
    ...
    result.push(new BaseMapViewModel({
        image: terria.baseUrl + 'images/france-natural-earth.png',
    ...
    result.push(new BaseMapViewModel({
        image: terria.baseUrl + 'images/france-black-marble.png',
    ...
    result.push(new BaseMapViewModel({
        image: terria.baseUrl + 'images/france-positron.png',
    ...
    result.push(new BaseMapViewModel({
        image: terria.baseUrl + 'images/france-dark-matter.png',
